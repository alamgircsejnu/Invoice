        ...
        <div class="row">
            ...
            <div style="margin: 5%">
                ...
                <div class="box box-primary" id="product-create-form">
                    {!! Form::model($editInvoice, ['method' => 'PATCH', 'route' => ['invoice.update', $editInvoice->id], 'files' => true]) !!}
                    ...
                    <div class="box-body row" style="margin-left: 1%;margin-right: 1%">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div id="customerInfo">
                                    <br>
                                    @if(isset($editInvoice->customer) && !empty($editInvoice->customer))
                                    <h3 id="customerNameInfo">{{ $editInvoice->customerName }}</h3>
                                    <p id="streetAddressInfo"></p><br>
                                    <p><b>Phone&nbsp;  :</b> &nbsp; <span id="phoneNumberInfo">{{ $editInvoice->phoneNumber }}</span></p>
                                    <p><b>Email&nbsp; :</b>&nbsp;&nbsp;&nbsp;<span id="emailAddressInfo">{{ $editInvoice->emailAddress }}</span></p>
                                     @else
                    ...
                    <div class="box-footer">
                        <?php
                        $count = 0;
                        $summarySubtotal = 0.00;
                        $summaryInvoiceTax = 0.00;
                        $summaryTotal = 0.00;
                        ?>
                        @foreach($editInvoice->items as $item)
                        <div class="invoice-item" id="clone-this-div{{ $count }}">
                            <div id="product-section" class="col-md-12 col-sm-12 col-xs-12">
                                <div class="input-group col-md-2 col-xs-12" id="product-item">
                                    <span class="input-group-addon" id="basic-addon-item" style="background-color: #EEEEEE">Item</span>
                                    {!! Form::text('item[]', $item->item, ['class' => 'form-control','aria-describedby' => 'basic-addon-item','id' => "cloning-item$count"]) !!}
                                </div>
                                <div class="input-group col-md-2 col-xs-6" id="product-quantity">
                                    <span class="input-group-addon" id="basic-addon-quantity" style="background-color: #EEEEEE;width: 20px;">Quantity</span>
                                    {!! Form::text('quantity[]', $item->quantity, ['class' => 'form-control','aria-describedby' => 'basic-addon-quantity','id' => "cloning-quantity$count"]) !!}
                                </div>
                                <div class="input-group col-md-2 col-xs-6" id="product-price">
                                    <span class="input-group-addon" id="basic-addon-price" style="background-color: #EEEEEE">Price</span>
                                    {!! Form::text('price[]', $item->price, ['class' => 'form-control','aria-describedby' => 'basic-addon-price','id' => "cloning-price$count"]) !!}
                                </div>
                                <div class="input-group col-md-2 col-xs-6" id="product-discount">
                                    <span class="input-group-addon" id="basic-addon-discount" style="background-color: #EEEEEE">Discount</span>
                                    {!! Form::text('discount[]', $item->discount, ['class' => 'form-control','aria-describedby' => 'basic-addon-discount','id' => "cloning-discount$count"]) !!}
                                </div>
                                <div class="input-group col-md-2 col-xs-6" id="product-taxRate">
                                    <span class="input-group-addon" id="basic-addon-taxRate" style="background-color: #EEEEEE">TAX Rate</span>
                                    {!! Form::select('taxRate[]',['None', '10% - GST'], $item->taxRate, ['class' => 'form-control','aria-describedby' => 'basic-addon-taxRate','id' => "cloning-taxRate$count"]) !!}
                                </div>
                                <div class="input-group col-md-2 col-xs-6" id="product-quantity">
                                    <span class="input-group-addon" id="basic-addon-expense" style="background-color: #EEEEEE;width: 20px;">Expense</span>
                                    {!! Form::text('expense[]', $item->expense, ['class' => 'form-control','aria-describedby' => 'basic-addon-expense','id' => 'cloning-expense0']) !!}
                                </div>
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="input-group col-md-4 col-xs-12" id="product-description" style="float:left; display: inline-table">
                                    ...
                                    {!! Form::textarea('description[]', $item->description, ['class' => 'form-control','aria-describedby' => 'basic-addon-description','id' => "cloning-description$count"]) !!}
                                </div>
                                <?php
                        ...
                        <div id="invoice-summery" class="pull-right col-md-5 col-xs-12">
                            <table style="width: 100%">
                                <tr>
                                    <td>Subtotal</td>
                                    <?php $summarySubtotal = round($summarySubtotal,2); ?>
                                    <td id="summary-subtotal">${{ $summarySubtotal }}</td>
                                </tr>
                                <tr>
                                    <td>Item Tax</td>
                                ...
                                <tr>
                                    <td>Invoice Tax</td>
                                    <?php $summaryInvoiceTax = round($summaryInvoiceTax,2); ?>
                                    <td id="summary-invoice-tax">${{ $summaryInvoiceTax }}</td>
                                </tr>
                                <tr>
                                    <td>Discount</td>
                                    <td class="clearfix">
                                ...
                                <tr>
                                    <td>Total</td>
                                    <?php $summaryTotal = round($summaryTotal,2); ?>
                                    <td id="summary-total"><b>${{ $summaryTotal }}</b></td>
                                </tr>
                                <tr>
                                    <td>Paid</td>
...
//            }
        ...
        var productAdded = '<?php echo $count; ?>';
        var clonedNum = '<?php echo $count-1; ?>';
        (function() {
