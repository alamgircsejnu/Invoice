...
@section('css')
    ...
    <style type="text/css">
        ...
        #show_images:hover #delete_button{
            display: block;
        }
        #delete_button {
            position:absolute;
        ...
        <div class="row">
            ...
            <div style="margin: 5%">
                <div class="box box-primary" id="product-create-form">
                    {!! Form::model($editProduct, ['method' => 'PATCH', 'route' => ['products.update', $editProduct->id], 'files' => true]) !!}
                    ...
                    <div class="box-body row" style="margin-left: 1%;margin-right: 1%">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('productId', $editProduct->productId, ['class' => 'form-control','required','autofocus','placeholder' => 'Product ID']) !!}
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('price', null, ['class' => 'form-control','required','autofocus','placeholder' => '00.00','id' => 'price','oninput' => 'calculateProfit()','onpropertychange' => 'calculateProfit()']) !!}
                            </div>
                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('gst_price', 'yes',null,['id' => 'priceTax','onclick'=>'calculateProfit()']) !!}
                                        Including GST(TAX)?
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('amount', null, ['class' => 'form-control','autofocus','placeholder' => '00.00','id' => 'amount','oninput' => 'calculateProfit()','onpropertychange' => 'calculateProfit()']) !!}
                            </div>
                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('gst_exp', 'yes',null,['id' => 'amountTax','onclick'=>'calculateProfit()']) !!}
                                        Including GST(TAX)?
                                    </label>
                                </div>
                            </div>
                        ...
                        {!! Form::hidden('imagesWithDropzone', null, ['class' => 'form-control','autofocus','id' => 'images']) !!}
                    ...
                    <div class="box-footer ">
                        @foreach($editProduct->images as $images)
                            <div id="show_images">
                                <img src="{!! asset($images->image_path) !!}" height="120px" width="110px">
                                <button id="delete_button"><img src="{!! asset('dist/img/img_delete_button.png') !!}"
                                             height="10" width="10" onclick="delete_image({{ $images->id }})"></button>
                            </div>
                        @endforeach
                    </div>
