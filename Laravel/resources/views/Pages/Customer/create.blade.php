...
@section('content')
    ...
    <div class="box box-primary" id="product-create-form">
        {!! Form::open(['route' => 'customer.store', 'files'=> true, 'enctype' => 'multipart/form-data']) !!}
            ...
            <div class="box-body row" style="margin-left: 1%;margin-right: 1%">
                ...
                <!-- select -->
                    <div class="form-group">
                        ...
                        {!! Form::text('streetAddress2', null, ['class' => 'form-control','autofocus','placeholder' => 'Street Address 2','id' => 'streetAddress2']) !!}
                    </div>
                <div class="form-group">
